...
pip install "../../dist/structuremap-0.0.8-py3-none-any.whl[stable]"
...
pkgbuild --root dist/structuremap --identifier de.mpg.biochem.structuremap.app --version 0.0.8 --install-location /Applications/structuremap.app --scripts scripts structuremap.pkg
