...
AppId={{structuremap_Mann_Labs_MPI_CPR}
AppName={#MyAppName}
...
OutputDir=dist
OutputBaseFilename=structuremap_gui_installer_windows
...
[Files]
Source: "dist\structuremap_gui\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "dist\structuremap_gui\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
